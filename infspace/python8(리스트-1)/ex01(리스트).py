...
# 손쉽게 처리할 수 있는 형태의 데이터의 저장 구조를 의마한다.

# 리스트를 선언
scores =[]
print("리스트 초기화 값 :", scores)

# append() 메서드를 통하여 값을 추가함.
scores.append(30)
print("리스트에 30을 추가한 값 :", scores)
...
for i in scores:
    ...
    # IndexError 발생, 저장할 방이 없는데 어떻게 저장을 해야 하나.
    # scores[i] = i + 10
    print(i)
...
# 아래와 같이 생성자의 매개변수가 문자열이라면
# 리스트를 생성할 때 문자 하나하나씩 요소로 가지게 된다.
li2 = list("안녕")
print("li2 : ", li2)

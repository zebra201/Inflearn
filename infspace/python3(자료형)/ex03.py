# 자동 판매기를 시뮬레이션하는 프로그램을 작성하여  사용자는 1000원권 지폐와
# 500원, 100원짜리 동전을 사용할 수가 있다. 물건값을 사용자로부터 입력을 받아서
# 1000원 지폐, 500원 동전, 100원 동전의 갯수를 입력하면 거스름돈을 계산하여
# 동전으로 반환하는 프로그램을 만들어보자.

itemPrice = int(input("물건 값을 입력하세요 :"))
bills_1000 = int(input("1000원 지폐 수 입력 :"))
coin_500 = int(input("500원 동전 수 입력 :"))
coin_100 = int(input("100원 동전 수 입력 :"))
...
# 1100원을 받았다면 nCoin500은 2의 값을 저장하게되고
# nod_money 는 100원의 값을 저장하게 된다.
...
# 거스름돈(1원 동전 개수)를 계산
# 1원짜리 동전은 더이상 나눌것이 없음.
nCoin1 = nod_money

print("500원 개수 : ", nCoin500, ", 100원 개수 : ", nCoin100, ", 50원 개수 : ", nCoin50, ", 10원 개수 : ", nCoin10, ", 1원 개수 : ", nCoin1)